#include "ColorblindCorrectionClass.h"
#include <cmath>

//Color Correction Algorithms
void ColorblindCorrection::LMS(float& r, float& g, float& b, short int flag)
...
void ColorblindCorrection::CBFS(float& r, float& g, float& b, short int flag)
{
    float h, s, l;
...
void ColorblindCorrection::setType(float rgb[3][3], short int flag)
{
...
void ColorblindCorrection::setColor(float rgb[3], short int flag)
{
    if (flag == 1) {
        rgb[0] = 255;
        rgb[1] = 0;
